...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class modio.CallbackProxy_DownloadModfilesById");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class modio.CallbackProxy_DownloadSubscribedModfiles");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class modio.CallbackProxy_GetMod");
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class modio.CallbackProxy_SetModEventListener");
		return ptr;
	}
...
public:
	...
	struct FScriptMulticastDelegate                    onSuccess;                                                // 0x0060(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    onFailure;                                                // 0x0070(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class modio.CallbackProxy_SubmitReport");
		return ptr;
	}


	class UCallbackProxy_SubmitReport* STATIC_SubmitReport(class UObject* WorldContext, TEnumAsByte<EModioResourceType> Resource, int ID, TEnumAsByte<EModioReportType> Report, const struct FString& Name, const struct FString& Summary);
};
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class modio.CallbackProxy_UninstallUnavailableMods");
		return ptr;
	}
...
public:
	...
	unsigned char                                      bRootDirectoryIsInUserSettingsDirectory : 1;              // 0x0050(0x0001) (Edit, Config)
	...
	unsigned char                                      bEnablePolling : 1;                                       // 0x0050(0x0001) (Edit, Config)
