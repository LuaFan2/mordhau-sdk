...
public:
	...
	class AAdvancedCharacter*                          Pulling;                                                  // 0x08E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
