...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GenericItemEntry.BP_GenericItemEntry_C.MarkSeen");
...
// Parameters:
// bool                           WasSeen                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UBP_GenericItemEntry_C::GetWasSeen(bool* WasSeen)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_GenericItemEntry.BP_GenericItemEntry_C.GetWasSeen");
