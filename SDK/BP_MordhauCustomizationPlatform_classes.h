...
public:
	...
	bool                                               ForceColorOverride;                                       // 0x045C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x045D(0x0003) MISSED OFFSET
	struct FLinearColor                                ColorAOverride;                                           // 0x0460(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FLinearColor                                ColorBOverride;                                           // 0x0470(0x0010) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	class UBP_MainMenu_C*                              MainMenu;                                                 // 0x0480(0x0008) (Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
