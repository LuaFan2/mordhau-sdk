...
public:
	...
	class UPhysicsHandleComponent*                     PhysicsHandle;                                            // 0x08E0(0x0008) (BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData)
	bool                                               DoNotAttachToPawns;                                       // 0x08E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
