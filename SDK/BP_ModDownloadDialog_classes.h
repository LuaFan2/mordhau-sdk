...
public:
	...
	TArray<int>                                        CurrentlyInstalledMods;                                   // 0x0270(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<int>                                        PreviouslyInstalledMods;                                  // 0x02E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FDateTime                                   Timestamp;                                                // 0x02F8(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnFailure_61D8F3FD4D4BA8FF9E81C1A564ECEC8C(const struct FModioResponse& response, bool mods_are_updated);
	void OnSuccess_61D8F3FD4D4BA8FF9E81C1A564ECEC8C(const struct FModioResponse& response, bool mods_are_updated);
