...
enum class EAlphaBlendOption : uint8_t
{
	...
	EAlphaBlendOption__CatmullRom  = 15,
	EAlphaBlendOption__EAlphaBlendOption_MAX = 16
};
...
struct FAlphaBlend
{
	...
	float                                              BlendTime;                                                // 0x0028(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x24];                                      // 0x002C(0x0024) MISSED OFFSET
};
...
struct FInputAlphaBoolBlend
{
	...
	struct FAlphaBlend                                 AlphaBlend;                                               // 0x0018(0x0050) (Transient)
	bool                                               bInitialized;                                             // 0x0068(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
struct FAnimMontageInstance
{
	...
	struct FAlphaBlend                                 Blend;                                                    // 0x0130(0x0050) (Transient)
	...
	unsigned char                                      UnknownData05[0x24];                                      // 0x01A4(0x0024) MISSED OFFSET
};
