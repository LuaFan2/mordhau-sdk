...
public:
	...
	class UBP_BattleRoyaleHUDWidget_C*                 BattleRoyaleHUDWidget;                                    // 0x0578(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	class UBP_BattleRoyaleEndScreen_C*                 BattleRoyaleEndScreen;                                    // 0x0580(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
