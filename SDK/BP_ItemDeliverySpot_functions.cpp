...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ItemDeliverySpot.BP_ItemDeliverySpot_C.IsInObjectiveArea");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ItemDeliverySpot.BP_ItemDeliverySpot_C.IsCompleted");
