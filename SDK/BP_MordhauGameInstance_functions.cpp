...
void UBP_MordhauGameInstance_C::JoinSessionSearchResult(struct FServerSearchResult* SearchResult)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MordhauGameInstance.BP_MordhauGameInstance_C.JoinSessionSearchResult");
