...
void UBP_ArmorCustomization_C::BndEvt__Dropdown_K2Node_ComponentBoundEvent_0_OnSelectionChangedEvent__DelegateSignature(const struct FText& SelectedItem, TEnumAsByte<ESelectInfo> SelectionType)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ArmorCustomization.BP_ArmorCustomization_C.BndEvt__Dropdown_K2Node_ComponentBoundEvent_0_OnSelectionChangedEvent__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_ArmorCustomization.BP_ArmorCustomization_C.UpdateTeamColorsPreview");
