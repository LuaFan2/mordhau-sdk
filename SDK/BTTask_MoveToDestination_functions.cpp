...
void UBTTask_MoveToDestination_C::SetPath(class AAIController* OwnerController, class APawn* ControlledPawn)
{
	static auto fn = UObject::FindObject<UFunction>("Function BTTask_MoveToDestination.BTTask_MoveToDestination_C.SetPath");
