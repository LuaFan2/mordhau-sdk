...
struct FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
	...
	struct FInputAlphaBoolBlend                        AlphaBoolBlend;                                           // 0x0068(0x0070) (Edit, BlueprintVisible)
	struct FName                                       AlphaCurveName;                                           // 0x00D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                      // 0x00E0(0x003C) (Edit, BlueprintVisible)
...
{
	struct FBoneReference                              IKBone;                                                   // 0x0130(0x0018) (Edit)
	unsigned char                                      bAllowStretching : 1;                                     // 0x0148(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0149(0x0003) MISSED OFFSET
	float                                              StartStretchRatio;                                        // 0x014C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxStretchScale;                                          // 0x0150(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   StretchLimits;                                            // 0x0154(0x0008) (Deprecated, IsPlainOldData)
	unsigned char                                      bTakeRotationFromEffectorSpace : 1;                       // 0x015C(0x0001) (Edit)
	unsigned char                                      bMaintainEffectorRelRot : 1;                              // 0x015C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x015D(0x0003) MISSED OFFSET
	TEnumAsByte<EBoneControlSpace>                     EffectorLocationSpace;                                    // 0x0160(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0161(0x0007) MISSED OFFSET
	struct FName                                       EffectorSpaceBoneName;                                    // 0x0168(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	struct FVector                                     EffectorLocation;                                         // 0x0170(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x017C(0x0004) MISSED OFFSET
	struct FBoneSocketTarget                           EffectorTarget;                                           // 0x0180(0x0060) (Edit)
	TEnumAsByte<EBoneControlSpace>                     JointTargetLocationSpace;                                 // 0x01E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01E1(0x0003) MISSED OFFSET
	struct FVector                                     JointTargetLocation;                                      // 0x01E4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FName                                       JointTargetSpaceBoneName;                                 // 0x01F0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData05[0x8];                                       // 0x01F8(0x0008) MISSED OFFSET
	struct FBoneSocketTarget                           JointTarget;                                              // 0x0200(0x0060) (Edit)
	bool                                               bAllowTwist;                                              // 0x0260(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x0261(0x0003) MISSED OFFSET
	struct FAxis                                       TwistAxis;                                                // 0x0264(0x0010) (Edit)
	bool                                               bNoTwist;                                                 // 0x0274(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData07[0xB];                                       // 0x0275(0x000B) MISSED OFFSET
};
...
{
	EAnimPhysSimSpaceType                              SimulationSpace;                                          // 0x0130(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0131(0x0007) MISSED OFFSET
	struct FBoneReference                              RelativeSpaceBone;                                        // 0x0138(0x0018) (Edit)
	bool                                               bChain;                                                   // 0x0150(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0151(0x0007) MISSED OFFSET
	struct FBoneReference                              BoundBone;                                                // 0x0158(0x0018) (Edit)
	struct FBoneReference                              ChainEnd;                                                 // 0x0170(0x0018) (Edit)
	struct FVector                                     BoxExtents;                                               // 0x0188(0x000C) (Edit, IsPlainOldData)
	struct FVector                                     LocalJointOffset;                                         // 0x0194(0x000C) (Edit, IsPlainOldData)
	float                                              GravityScale;                                             // 0x01A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bLinearSpring;                                            // 0x01A4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAngularSpring;                                           // 0x01A5(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x01A6(0x0002) MISSED OFFSET
	...
	bool                                               bEnableWind;                                              // 0x01B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bWindWasEnabled;                                          // 0x01B1(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x01B2(0x0002) MISSED OFFSET
	float                                              WindScale;                                                // 0x01B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideLinearDamping;                                   // 0x01B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01B9(0x0003) MISSED OFFSET
	float                                              LinearDampingOverride;                                    // 0x01BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularDamping;                                  // 0x01C0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x01C1(0x0003) MISSED OFFSET
	float                                              AngularDampingOverride;                                   // 0x01C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bOverrideAngularBias;                                     // 0x01C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x3];                                       // 0x01C9(0x0003) MISSED OFFSET
	float                                              AngularBiasOverride;                                      // 0x01CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDoUpdate;                                                // 0x01D0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bDoEval;                                                  // 0x01D1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x2];                                       // 0x01D2(0x0002) MISSED OFFSET
	int                                                NumSolverIterationsPreUpdate;                             // 0x01D4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                NumSolverIterationsPostUpdate;                            // 0x01D8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FAnimPhysConstraintSetup                    ConstraintSetup;                                          // 0x01DC(0x005C) (Edit)
	bool                                               bUsePlanarLimit;                                          // 0x0238(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x7];                                       // 0x0239(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysPlanarLimit>                PlanarLimits;                                             // 0x0240(0x0010) (Edit, ZeroConstructor)
	bool                                               bUseSphericalLimits;                                      // 0x0250(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x7];                                       // 0x0251(0x0007) MISSED OFFSET
	TArray<struct FAnimPhysSphericalLimit>             SphericalLimits;                                          // 0x0258(0x0010) (Edit, ZeroConstructor)
	EAnimPhysCollisionType                             CollisionType;                                            // 0x0268(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0x3];                                       // 0x0269(0x0003) MISSED OFFSET
	float                                              SphereCollisionRadius;                                    // 0x026C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector                                     ExternalForce;                                            // 0x0270(0x000C) (Edit, IsPlainOldData)
	unsigned char                                      UnknownData11[0x124];                                     // 0x027C(0x0124) MISSED OFFSET
};
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	struct FInputAlphaBoolBlend                        AlphaBoolBlend;                                           // 0x0078(0x0070) (Edit, BlueprintVisible)
	struct FName                                       AlphaCurveName;                                           // 0x00E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                      // 0x00F0(0x003C) (Edit, BlueprintVisible)
...
{
	TArray<struct FAngularRangeLimit>                  AngularRangeLimits;                                       // 0x0130(0x0010) (Edit, ZeroConstructor)
	TArray<struct FVector>                             AngularOffsets;                                           // 0x0140(0x0010) (Edit, BlueprintVisible, EditFixedSize, ZeroConstructor)
};
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	TEnumAsByte<EComponentType>                        SourceComponent;                                          // 0x0148(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0149(0x0007) MISSED OFFSET
	class UCurveFloat*                                 DrivingCurve;                                             // 0x0150(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Multiplier;                                               // 0x0158(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseRange;                                                // 0x015C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x015D(0x0003) MISSED OFFSET
	float                                              RangeMin;                                                 // 0x0160(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RangeMax;                                                 // 0x0164(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RemappedMin;                                              // 0x0168(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RemappedMax;                                              // 0x016C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	EDrivenDestinationMode                             DestinationMode;                                          // 0x0170(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0171(0x0007) MISSED OFFSET
	struct FName                                       ParameterName;                                            // 0x0178(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FBoneReference                              TargetBone;                                               // 0x0180(0x0018) (Edit)
	TEnumAsByte<EComponentType>                        TargetComponent;                                          // 0x0198(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0199(0x0003) MISSED OFFSET
	unsigned char                                      bAffectTargetTranslationX : 1;                            // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetTranslationY : 1;                            // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetTranslationZ : 1;                            // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetRotationX : 1;                               // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetRotationY : 1;                               // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetRotationZ : 1;                               // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetScaleX : 1;                                  // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetScaleY : 1;                                  // 0x019C(0x0001) (Edit)
	unsigned char                                      bAffectTargetScaleZ : 1;                                  // 0x019D(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x2];                                       // 0x019E(0x0002) MISSED OFFSET
	EDrivenBoneModificationMode                        ModificationMode;                                         // 0x01A0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x0130(0x0018) (Edit)
	TArray<struct FConstraint>                         ConstraintSetup;                                          // 0x0148(0x0010) (Edit, ZeroConstructor)
	TArray<float>                                      ConstraintWeights;                                        // 0x0158(0x0010) (Edit, EditFixedSize, ZeroConstructor)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bCopyTranslation;                                         // 0x0160(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCopyRotation;                                            // 0x0161(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCopyScale;                                               // 0x0162(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     ControlSpace;                                             // 0x0163(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FAnimNode_CopyBoneDelta : public FAnimNode_SkeletalControlBase
{
	...
	bool                                               bCopyRotation;                                            // 0x0161(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bCopyScale;                                               // 0x0162(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ECopyBoneDeltaMode                                 CopyMode;                                                 // 0x0163(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TranslationMultiplier;                                    // 0x0164(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              RotationMultiplier;                                       // 0x0168(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScaleMultiplier;                                          // 0x016C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	struct FTransform                                  EffectorTransform;                                        // 0x0130(0x0030) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     EffectorTransformSpace;                                   // 0x0160(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0161(0x0007) MISSED OFFSET
	struct FBoneReference                              EffectorTransformBone;                                    // 0x0168(0x0018) (Deprecated)
	struct FBoneSocketTarget                           EffectorTarget;                                           // 0x0180(0x0060) (Edit)
	TEnumAsByte<EBoneRotationSource>                   EffectorRotationSource;                                   // 0x01E0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x01E1(0x0007) MISSED OFFSET
	struct FBoneReference                              TipBone;                                                  // 0x01E8(0x0018) (Edit)
	struct FBoneReference                              RootBone;                                                 // 0x0200(0x0018) (Edit)
	float                                              Precision;                                                // 0x0218(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxIterations;                                            // 0x021C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableDebugDraw;                                         // 0x0220(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xF];                                       // 0x0221(0x000F) MISSED OFFSET
};
...
{
	struct FBoneReference                              RightHandFK;                                              // 0x0130(0x0018) (Edit)
	struct FBoneReference                              LeftHandFK;                                               // 0x0148(0x0018) (Edit)
	struct FBoneReference                              RightHandIK;                                              // 0x0160(0x0018) (Edit)
	struct FBoneReference                              LeftHandIK;                                               // 0x0178(0x0018) (Edit)
	TArray<struct FBoneReference>                      IKBonesToMove;                                            // 0x0190(0x0010) (Edit, ZeroConstructor)
	float                                              HandFKWeight;                                             // 0x01A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	float                                              ReachPrecision;                                           // 0x0130(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxIterations;                                            // 0x0134(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FAnimLegIKDefinition>                LegsDefinition;                                           // 0x0138(0x0010) (Edit, ZeroConstructor)
	TArray<struct FAnimLegIKData>                      LegsData;                                                 // 0x0148(0x0010) (ZeroConstructor, Transient)
...
// 0x0130 (0x0260 - 0x0130)
struct FAnimNode_LookAt : public FAnimNode_SkeletalControlBase
{
	struct FBoneReference                              BoneToModify;                                             // 0x0130(0x0018) (Edit)
	struct FBoneReference                              LookAtBone;                                               // 0x0148(0x0018) (Deprecated)
	struct FName                                       LookAtSocket;                                             // 0x0160(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0168(0x0008) MISSED OFFSET
	struct FBoneSocketTarget                           LookAtTarget;                                             // 0x0170(0x0060) (Edit)
	struct FVector                                     LookAtLocation;                                           // 0x01D0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookAtAxis;                                               // 0x01DC(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x01DD(0x0003) MISSED OFFSET
	struct FVector                                     CustomLookAtAxis;                                         // 0x01E0(0x000C) (Deprecated, IsPlainOldData)
	struct FAxis                                       LookAt_Axis;                                              // 0x01EC(0x0010) (Edit)
	bool                                               bUseLookUpAxis;                                           // 0x01FC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EAxisOption>                           LookUpAxis;                                               // 0x01FD(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x01FE(0x0002) MISSED OFFSET
	struct FVector                                     CustomLookUpAxis;                                         // 0x0200(0x000C) (Deprecated, IsPlainOldData)
	struct FAxis                                       LookUp_Axis;                                              // 0x020C(0x0010) (Edit)
	float                                              LookAtClamp;                                              // 0x021C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EInterpolationBlend>                   InterpolationType;                                        // 0x0220(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0221(0x0003) MISSED OFFSET
	float                                              InterpolationTime;                                        // 0x0224(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              InterpolationTriggerThreashold;                           // 0x0228(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x34];                                      // 0x022C(0x0034) MISSED OFFSET
};
...
{
	struct FBoneReference                              BoneToModify;                                             // 0x0130(0x0018) (Edit)
	struct FVector                                     Translation;                                              // 0x0148(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x0154(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x0160(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 TranslationMode;                                          // 0x016C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 RotationMode;                                             // 0x016D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneModificationMode>                 ScaleMode;                                                // 0x016E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     TranslationSpace;                                         // 0x016F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     RotationSpace;                                            // 0x0170(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneControlSpace>                     ScaleSpace;                                               // 0x0171(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	struct FBoneReference                              BoneToObserve;                                            // 0x0130(0x0018) (Edit)
	TEnumAsByte<EBoneControlSpace>                     DisplaySpace;                                             // 0x0148(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRelativeToRefPose;                                       // 0x0149(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x014A(0x0002) MISSED OFFSET
	struct FVector                                     Translation;                                              // 0x014C(0x000C) (IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x0158(0x000C) (IsPlainOldData)
	struct FVector                                     Scale;                                                    // 0x0164(0x000C) (IsPlainOldData)
};
...
struct FRandomPlayerSequenceEntry
{
	...
	struct FAlphaBlend                                 BlendIn;                                                  // 0x0020(0x0050) (Edit)
};
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
	...
	struct FInputAlphaBoolBlend                        AlphaBoolBlend;                                           // 0x0160(0x0070) (Edit, BlueprintVisible)
	struct FName                                       AlphaCurveName;                                           // 0x01D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                      // 0x01D8(0x003C) (Edit, BlueprintVisible)
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	struct FBoneReference                              SourceBone;                                               // 0x0148(0x0018) (Edit)
	float                                              Multiplier;                                               // 0x0160(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBoneAxis>                             RotationAxisToRefer;                                      // 0x0164(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bIsAdditive;                                              // 0x0165(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x01B8 (0x02E8 - 0x0130)
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
	struct FBoneReference                              StartBone;                                                // 0x0130(0x0018) (Edit)
	struct FBoneReference                              EndBone;                                                  // 0x0148(0x0018) (Edit)
	ESplineBoneAxis                                    BoneAxis;                                                 // 0x0160(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bAutoCalculateSpline;                                     // 0x0161(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0162(0x0002) MISSED OFFSET
	int                                                PointCount;                                               // 0x0164(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FTransform>                          ControlPoints;                                            // 0x0168(0x0010) (Edit, BlueprintVisible, EditFixedSize, ZeroConstructor)
	float                                              Roll;                                                     // 0x0178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TwistStart;                                               // 0x017C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TwistEnd;                                                 // 0x0180(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0184(0x0004) MISSED OFFSET
	struct FAlphaBlend                                 TwistBlend;                                               // 0x0188(0x0050) (Edit)
	float                                              Stretch;                                                  // 0x01D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              Offset;                                                   // 0x01DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x70];                                      // 0x01E0(0x0070) MISSED OFFSET
	struct FSplineCurves                               BoneSpline;                                               // 0x0250(0x0060)
	float                                              OriginalSplineLength;                                     // 0x02B0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x02B4(0x0004) MISSED OFFSET
	TArray<struct FSplineIKCachedBoneData>             CachedBoneReferences;                                     // 0x02B8(0x0010) (ZeroConstructor)
	TArray<float>                                      CachedBoneLengths;                                        // 0x02C8(0x0010) (ZeroConstructor)
	TArray<struct FQuat>                               CachedOffsetRotations;                                    // 0x02D8(0x0010) (ZeroConstructor)
};
...
{
	struct FBoneReference                              SpringBone;                                               // 0x0130(0x0018) (Edit)
	bool                                               bLimitDisplacement;                                       // 0x0148(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0149(0x0003) MISSED OFFSET
	float                                              MaxDisplacement;                                          // 0x014C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              ErrorResetThresh;                                         // 0x0158(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bNoZSpring;                                               // 0x015C(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
	bool                                               bTranslateX;                                              // 0x015D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bTranslateY;                                              // 0x015E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bTranslateZ;                                              // 0x015F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRotateX;                                                 // 0x0160(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRotateY;                                                 // 0x0161(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRotateZ;                                                 // 0x0162(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x35];                                      // 0x0163(0x0035) MISSED OFFSET
};
...
{
	struct FBoneReference                              TrailBone;                                                // 0x0130(0x0018) (Edit)
	int                                                ChainLength;                                              // 0x0148(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EAxis>                                 ChainBoneAxis;                                            // 0x014C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bInvertChainBoneAxis;                                     // 0x014D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x014E(0x0002) MISSED OFFSET
	float                                              TrailRelaxation;                                          // 0x0150(0x0004) (ZeroConstructor, Deprecated, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0154(0x0004) MISSED OFFSET
	struct FRuntimeFloatCurve                          TrailRelaxationSpeed;                                     // 0x0158(0x0078) (Edit)
	float                                              RelaxationSpeedScale;                                     // 0x01D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FInputScaleBiasClamp                        RelaxationSpeedScaleInputProcessor;                       // 0x01D4(0x003C) (Edit, BlueprintVisible)
	bool                                               bLimitStretch;                                            // 0x0210(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0211(0x0003) MISSED OFFSET
	float                                              StretchLimit;                                             // 0x0214(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData04[0x70];                                      // 0x0240(0x0070) MISSED OFFSET
};
...
{
	struct FReferenceBoneFrame                         BaseFrame;                                                // 0x0130(0x0028) (Edit)
	struct FReferenceBoneFrame                         TwistFrame;                                               // 0x0158(0x0028) (Edit)
	struct FAxis                                       TwistPlaneNormalAxis;                                     // 0x0180(0x0010) (Edit)
	float                                              RangeMax;                                                 // 0x0190(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RemappedMin;                                              // 0x0194(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              RemappedMax;                                              // 0x0198(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x019C(0x0004) MISSED OFFSET
	struct FAnimCurveParam                             Curve;                                                    // 0x01A0(0x0010) (Edit)
...
struct FAnimNode_TwoWayBlend : public FAnimNode_Base
{
	...
	struct FName                                       AlphaCurveName;                                           // 0x00E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                      // 0x00F0(0x003C) (Edit, BlueprintVisible)
	float                                              InternalBlendAlpha;                                       // 0x012C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bAIsRelevant;                                             // 0x0130(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bBIsRelevant;                                             // 0x0131(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bResetChildOnActivation;                                  // 0x0132(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      UnknownData00[0x260];                                     // 0x05E0(0x0260) MISSED OFFSET
};
