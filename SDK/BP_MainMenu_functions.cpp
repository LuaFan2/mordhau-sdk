...
ESlateVisibility UBP_MainMenu_C::Get_ReturnButton_Visibility_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenu.BP_MainMenu_C.Get_ReturnButton_Visibility_1");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenu.BP_MainMenu_C.BndEvt__ReturnButton_K2Node_ComponentBoundEvent_12_OnClick__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenu.BP_MainMenu_C.BndEvt__ScoreboardButton_K2Node_ComponentBoundEvent_13_OnClick__DelegateSignature");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenu.BP_MainMenu_C.BndEvt__HomeSubNavButton_K2Node_ComponentBoundEvent_14_OnClick__DelegateSignature");
...
void UBP_MainMenu_C::ShowMainMenu(TEnumAsByte<E_ArmoryStates>* ArmoryState)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenu.BP_MainMenu_C.ShowMainMenu");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenu.BP_MainMenu_C.HideMainMenu");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_MainMenu.BP_MainMenu_C.Show Menu Scoreboard");
