...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeEnemy.BP_HordeEnemy_C.AttemptClimb");
...
// Parameters:
// struct FHitResult              Impact                         (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData)

void ABP_HordeEnemy_C::HandleObstructionRemoval(const struct FHitResult& Impact)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeEnemy.BP_HordeEnemy_C.HandleObstructionRemoval");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HordeEnemy.BP_HordeEnemy_C.ReceivePossessed");
