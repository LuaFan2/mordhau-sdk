...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_FrontlinePushable.BP_FrontlinePushable_C.IsInObjectiveArea");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_FrontlinePushable.BP_FrontlinePushable_C.IsCompleted");
