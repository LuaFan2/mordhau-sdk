...
struct UBP_ReusableNavTabButton_C_Deselect_Params
{
};

// Function BP_ReusableNavTabButton.BP_ReusableNavTabButton_C.Select
struct UBP_ReusableNavTabButton_C_Select_Params
{
};

// Function BP_ReusableNavTabButton.BP_ReusableNavTabButton_C.Construct
struct UBP_ReusableNavTabButton_C_Construct_Params
{
};
...
struct UBP_ReusableNavTabButton_C_BndEvt__Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function BP_ReusableNavTabButton.BP_ReusableNavTabButton_C.PreConstruct
struct UBP_ReusableNavTabButton_C_PreConstruct_Params
{
	bool*                                              IsDesignTime;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_ReusableNavTabButton.BP_ReusableNavTabButton_C.ExecuteUbergraph_BP_ReusableNavTabButton
struct UBP_ReusableNavTabButton_C_ExecuteUbergraph_BP_ReusableNavTabButton_Params
{
	int                                                EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_ReusableNavTabButton.BP_ReusableNavTabButton_C.ButtonDeselected__DelegateSignature
struct UBP_ReusableNavTabButton_C_ButtonDeselected__DelegateSignature_Params
{
};

// Function BP_ReusableNavTabButton.BP_ReusableNavTabButton_C.ButtonSelected__DelegateSignature
struct UBP_ReusableNavTabButton_C_ButtonSelected__DelegateSignature_Params
{
};
