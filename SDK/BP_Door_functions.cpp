...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Door.BP_Door_C.IsClosed");
...
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// unsigned char                  InStartingState                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// unsigned char                  ToDoorState                    (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABP_Door_C::ConvertStartingStateToDoorState(unsigned char InStartingState, unsigned char* ToDoorState)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Door.BP_Door_C.ConvertStartingStateToDoorState");
