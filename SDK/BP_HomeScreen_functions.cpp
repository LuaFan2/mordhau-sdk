...
ESlateVisibility UBP_HomeScreen_C::Get_ToggleNewsButton_Visibility_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.Get_ToggleNewsButton_Visibility_1");

	UBP_HomeScreen_C_Get_ToggleNewsButton_Visibility_1_Params params;
...
ESlateVisibility UBP_HomeScreen_C::Get_CloseMenuButton_Visibility_1()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_HomeScreen.BP_HomeScreen_C.Get_CloseMenuButton_Visibility_1");

	UBP_HomeScreen_C_Get_CloseMenuButton_Visibility_1_Params params;
